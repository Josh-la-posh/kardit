export default function Hero() {
  return (
    <section className="py-20 md:py-32 px-5 bg-gradient-to-br from-orange-50 to-transparent dark:from-orange-950/20 dark:to-transparent border-b border-gray-200 dark:border-gray-800">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <a href="#features" className="px-8 py-4 bg-transparent text-orange-600 dark:text-orange-400 font-semibold rounded-lg border-2 border-orange-600 dark:border-orange-400 hover:bg-orange-50 dark:hover:bg-orange-950/20 transition-colors text-center">
              Learn More
            </a>
          </div>
        </div>
