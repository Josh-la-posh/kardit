...
export default function IssuingBankCreatePage() {
  ...
  const countrySelectInputClassName = [
    'h-10 w-full rounded-md bg-muted px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50',
    errors.country ? 'border border-[hsl(var(--destructive))]' : 'border border-border',
  ].join(' ');
        ...
        <main className= "scr-main">
          <div className="container">
            <header className="page-head">
              <div>
                <h1 className="page-title">Add Issuing Bank</h1>
                <p className='page-sub'>Capture the bank details, review them, then submit once to provision the bank.</p>
              </div>
