        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="grid-2">
            <div className={`field ${errors.email ? 'has-error' : ''}`}>
              ...
              <input type="email" value={f.email} readOnly aria-readonly="true" title="Provided when onboarding was started" />
              {errors.email && <span className="err"><Icon name="alert" size={13} color="var(--cs-red-700)" />{errors.email}</span>}
            </div>
            <div className="field">
              <label>Phone</label>
              <input value={f.phone} readOnly aria-readonly="true" title="Provided when onboarding was started" />
            </div>
          </div>
        </div>
      </div>
